...
export default function SideNavbar() {
  return (
    <div class="d-flex flex-column align-items-center align-items-sm-start px-5 pt-2 text-white min-vh-100" style={{backgroundColor: '#581518'}}>
      <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
        ...
        <li>
          <Link to="/locator" class="nav-link text-white px-0 align-middle">
            <span class="ms-1 d-none d-sm-inline">Locator</span> 
          </Link>
        </li>
        <li>
        ...
        <li>
          <Link to="/community" class="nav-link text-white px-0 align-middle">
            <span class="ms-1 d-none d-sm-inline">Community</span>
          </Link>
        </li>
      </ul>
   </div>
